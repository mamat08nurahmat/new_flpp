        ...
        <div class="box box-warning">
          ...
          <?php endif; ?>
            <table width="100%" class="table table-striped">
              ...
              <tbody>
                <tr>
                  <td>../application/config/database.php <?= cclang('is_writable'); ?></td>
                  <td>
                ...
                <tr>
                  <td>../application/config/config.php <?= cclang('is_writable'); ?></td>
                  <td>
                ...
                <tr>
                  <td>../application/migrations/001_cicool.php <?= cclang('is_writable'); ?></td>
                  <td>
