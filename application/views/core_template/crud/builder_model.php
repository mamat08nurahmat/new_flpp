...
private $primary_key 	= '{primary_key}';
	...
	public function join_avaiable() {
		...
		<?php foreach ($this->crud_builder->getFieldRelation() as $field => $join): 
	        ?>$this->db->join('<?= $join['relation_table']; ?>', '<?= $join['relation_table']; ?>.<?= $join['relation_value']; ?> = {table_name}.<?= $field; ?>', 'LEFT');
	    	<?php endforeach; ?>
