                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <?php foreach($forms as $form): ?>
                        <tr>
                           ...
                           <td width="280">
                              <?php is_allowed('form_manage', function($form) use ($form){?>
